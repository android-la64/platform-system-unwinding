...
template<>
std::vector<Register> ExpectedRegisters<RegsLoongarch64>() {
  std::vector<Register> result;
  result.push_back({"pc", LOONGARCH64_REG_PC});
  result.push_back({"ra", LOONGARCH64_REG_RA});
  result.push_back({"r2", LOONGARCH64_REG_R2});
  result.push_back({"sp", LOONGARCH64_REG_SP});
  result.push_back({"r4", LOONGARCH64_REG_R4});
  result.push_back({"r5", LOONGARCH64_REG_R5});
  result.push_back({"r6", LOONGARCH64_REG_R6});
  result.push_back({"r7", LOONGARCH64_REG_R7});
  result.push_back({"r8", LOONGARCH64_REG_R8});
  result.push_back({"r9", LOONGARCH64_REG_R9});
  result.push_back({"r10", LOONGARCH64_REG_R10});
  result.push_back({"r11", LOONGARCH64_REG_R11});
  result.push_back({"r12", LOONGARCH64_REG_R12});
  result.push_back({"r13", LOONGARCH64_REG_R13});
  result.push_back({"r14", LOONGARCH64_REG_R14});
  result.push_back({"r15", LOONGARCH64_REG_R15});
  result.push_back({"r16", LOONGARCH64_REG_R16});
  result.push_back({"r17", LOONGARCH64_REG_R17});
  result.push_back({"r18", LOONGARCH64_REG_R18});
  result.push_back({"r19", LOONGARCH64_REG_R19});
  result.push_back({"r20", LOONGARCH64_REG_R20});
  result.push_back({"r21", LOONGARCH64_REG_R21});
  result.push_back({"r22", LOONGARCH64_REG_R22});
  result.push_back({"r23", LOONGARCH64_REG_R23});
  result.push_back({"r24", LOONGARCH64_REG_R24});
  result.push_back({"r25", LOONGARCH64_REG_R25});
  result.push_back({"r26", LOONGARCH64_REG_R26});
  result.push_back({"r27", LOONGARCH64_REG_R27});
  result.push_back({"r28", LOONGARCH64_REG_R28});
  result.push_back({"r29", LOONGARCH64_REG_R29});
  result.push_back({"r30", LOONGARCH64_REG_R30});
  result.push_back({"r31", LOONGARCH64_REG_R31});

  return result;
}

using RegTypes = ::testing::Types<RegsArm, RegsArm64, RegsX86, RegsX86_64, RegsMips, RegsMips64, RegsLoongarch64>;
