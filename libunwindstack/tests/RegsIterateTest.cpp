...
std::vector<Register> ExpectedRegisters<RegsLoongarch64>() {
  ...
  result.push_back({"gp", LOONGARCH64_REG_GP});
  result.push_back({"tp", LOONGARCH64_REG_TP});
  result.push_back({"t0", LOONGARCH64_REG_T0});
  result.push_back({"t1", LOONGARCH64_REG_T1});
  result.push_back({"t2", LOONGARCH64_REG_T2});
  result.push_back({"s0", LOONGARCH64_REG_S0});
  result.push_back({"s1", LOONGARCH64_REG_S1});
  result.push_back({"a0", LOONGARCH64_REG_A0});
  result.push_back({"a1", LOONGARCH64_REG_A1});
  result.push_back({"a2", LOONGARCH64_REG_A2});
  result.push_back({"a3", LOONGARCH64_REG_A3});
  result.push_back({"a4", LOONGARCH64_REG_A4});
  result.push_back({"a5", LOONGARCH64_REG_A5});
  result.push_back({"a6", LOONGARCH64_REG_A6});
  result.push_back({"a7", LOONGARCH64_REG_A7});
  result.push_back({"s2", LOONGARCH64_REG_S2});
  result.push_back({"s3", LOONGARCH64_REG_S3});
  result.push_back({"s4", LOONGARCH64_REG_S4});
  result.push_back({"s5", LOONGARCH64_REG_S5});
  result.push_back({"s6", LOONGARCH64_REG_S6});
  result.push_back({"s7", LOONGARCH64_REG_S7});
  result.push_back({"s8", LOONGARCH64_REG_S8});
  result.push_back({"s9", LOONGARCH64_REG_S9});
  result.push_back({"s10", LOONGARCH64_REG_S10});
  result.push_back({"s11", LOONGARCH64_REG_S11});
  result.push_back({"t3", LOONGARCH64_REG_T3});
  result.push_back({"t4", LOONGARCH64_REG_T4});
  result.push_back({"t5", LOONGARCH64_REG_T5});
  result.push_back({"t6", LOONGARCH64_REG_T6});
