...
#ifndef _LIBUNWINDSTACK_REGS_LOONGARCH64_H
#define _LIBUNWINDSTACK_REGS_LOONGARCH64_H
...
class RegsLoongarch64 : public RegsImpl<uint64_t> {
 public:
  RegsLoongarch64();
  virtual ~RegsLoongarch64() = default;
...
#endif  // _LIBUNWINDSTACK_REGS_LOONGARCH64_H
